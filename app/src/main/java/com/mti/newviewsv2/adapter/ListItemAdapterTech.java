...
public class ListItemAdapterTech extends RecyclerView.Adapter<ListItemAdapterTech.ListItemViewHolder>{
...
/*End of ViewHolder Class*/
   ...
   private Context mContext;
    ...
    public ListItemAdapterTech(Context mContext, List<?> dataList, ItemClickListener itemClickListener) {
    ...
    public ListItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.home_body_recycler_fragment_card, parent,false);
